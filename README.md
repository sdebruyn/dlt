...
- [dlt-hub/dlt#4259](https://github.com/dlt-hub/dlt/pull/4259): correct nvarchar-to-varchar length scaling in the Fabric type mapper (character precision x 4 for UTF-8 byte semantics), and drop the inherited SQL Server 900 byte cap on unique text columns, which Fabric Warehouse does not enforce.
